...
async def run():
    ...
    os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Jagerblue/Anime_Dex/blob/main.safetensors -d /content/stable-diffusion-webui/models/Stable-diffusion -o Aniverse_thxEd14Pruned.safetensors")
