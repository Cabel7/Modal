...
async def run():
    ...
    os.system(f"git clone https://github.com/DominikDoom/a1111-sd-webui-tagcomplete.git /kaggle/stable-diffusion-webui/extensions/tag-autocomplete") 
    os.system(f"git clone https://github.com/camenduru/stable-diffusion-webui-huggingface /kaggle/stable-diffusion-webui/extensions/stable-diffusion-webui-huggingface") 
    ...
    os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/ckpt/sd_xl_base_1.0/resolve/main/sd_xl_base_1.0.safetensors -d /content/stable-diffusion-webui/models/Stable-diffusion -o sd_xl_base_1.0.safetensors)
